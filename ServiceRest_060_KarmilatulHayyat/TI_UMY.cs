...
namespace ServiceRest_060_KarmilatulHayyat
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data source=LAPTOP-AUR1I1DH; Initial Catalog=\"TI UMY\"; Persist Security Info = True;User ID=sa;Password=pergisaja"); // Authentication=Windows Authentication
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data source=LAPTOP-AUR1I1DH; Initial Catalog=\"TI UMY\"; Persist Security Info = True;User ID=sa;Password=pergisaja"); // Authentication=Windows Authentication
